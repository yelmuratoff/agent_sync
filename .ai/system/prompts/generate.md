...
AgentSync keeps all AI instructions in `.ai/src/` and distributes them to tool-specific directories (Claude, Cursor, Copilot, Gemini, Codex, Windsurf, Junie, Amp, Aider) via `agentsync sync`. Your job is to study my project and produce tailored, specific configuration.
